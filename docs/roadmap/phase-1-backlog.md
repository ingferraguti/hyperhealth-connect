...
|---|---|---|---|---|---|---|
| WP1-01 Scoped platform | gerarchia e API tenancy/identity persistenti | FR-TEN-001/002/003, NFR-SEC-001/002/003, NFR-SCL-001 | UC-CLIN-001, UC-SEC-01 | Platform Engineering | query/cache/API senza scope falliscono; matrice cross-tenant/facility nega prima del payload; migration fresh/N-1, secret reference e seed/piani da 12.000 Endpoint verdi | `evidence/R0.2/G2/` isolation, internationalization, inventory-scale, migration e schema report |
