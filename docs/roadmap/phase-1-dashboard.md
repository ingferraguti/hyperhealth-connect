...
| WP1-01 Tenancy/identity/DB | VERIFYING — P1-0101…0110 implemented | G2 PENDING | [#4](https://github.com/ingferraguti/hyperhealth-connect/issues/4) | CI/evidence G2 e review security/IAM indipendente |
